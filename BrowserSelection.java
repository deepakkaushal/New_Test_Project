...
public class BrowserSelection implements ClassObject {
	...
	@BeforeClass(alwaysRun = true, groups = {"Smoke", "Regression","Harman","Harinder","Jasmeet","Deepak"}, enabled = true)
...
case "AS":
			System.setProperty("webdriver.safari.driver",
					System.getProperty("user.dir") + GlobalComponents.safariExrcutable);
...
//			driver.manage().deleteAllCookies();
	...
	@AfterClass(alwaysRun = true, groups = {"Smoke", "Regression","Harman","Harinder","Jasmeet","Deepak"}, enabled = true)
	public void exit()
	{
	...
	@AfterSuite(alwaysRun = true, groups = {"Smoke", "Regression","Harman","Harinder","Jasmeet","Deepak"}, enabled = true)
	...
	public static void driverClose() 
	{
		if (driverFlag) {
			driver.close();
			extentTest.log(LogStatus.INFO, "'driver' is closed by BrowserSelection.driverClose()");
		}
		else{
			if (privateDriver != null) 
			{
			privateDriver.close();
			privateDriver = null;
			extentTest.log(LogStatus.INFO, "'privateDriver' is closed by BrowserSelection.driverClose()");
			}
			driverFlag = true;
		}
	}
